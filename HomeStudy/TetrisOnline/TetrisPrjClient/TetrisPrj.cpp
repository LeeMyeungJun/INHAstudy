...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_TETRISPRJ));
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_GETMINMAXINFO:
		((MINMAXINFO *)lParam)->ptMaxTrackSize.x = 1150;
		((MINMAXINFO *)lParam)->ptMaxTrackSize.y = 905;
		((MINMAXINFO *)lParam)->ptMinTrackSize.x = 1150;
		((MINMAXINFO *)lParam)->ptMinTrackSize.y = 905;
		return FALSE;
    case WM_COMMAND:
        {
